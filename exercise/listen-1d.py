...
# 3) Schleife über alle Elemente der Liste(alle einmal schreiben)
for note in noten:
    print(note)

# 4) Schleife über alle Elemente der Liste mit Index(alle nummern und welche wo sie plaziert sind)
...
# 9) Die Liste aufsteigend sortieren(absteigend?)
noten.sort()
print(noten)
